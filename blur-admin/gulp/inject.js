...
gulp.task('inject', ['scripts', 'styles', 'injectAuth', 'inject404', 'copyVendorImages','injectData'], function () {
...
gulp.task('injectData',[],function(){
    gulp.src(path.join(conf.paths.src, '/data/**/*.json'))
        .pipe(gulp.dest(path.join(conf.paths.tmp, '/serve/data')));
});
